...
```{r}
name <- "Simulation1_2020-10-28_1000_empirical_welch_empiricalcoef_empiricalgrowth_empiricalindex"
...
## Save prop summary
```{r}
save(summary_emerge_prop, file = "../../results/data/summary_emerge_prop_base_Oct28.Rdata")
```
...
ggplot(summary_emerge_prop)+
  ...
  xlim(9,max_year)+
  ylim(c(0,1))
filename <- paste("../../results/figures/Simulations/base_prop_line_Oct28", name, ".png", sep = "")
ggsave(file = filename, width = 5, height =4, dpi = 400)
```
...
```{r}
save(summary_emerge_density, file = "../../results/data/summary_emerge_density_base_Oct28.Rdata")
```
...
filename <- paste("../../results/figures/Simulations/base_density_line_Oct28", name, ".png", sep = "")
ggsave(file = filename, width = 5, height =4, dpi = 400)
```
