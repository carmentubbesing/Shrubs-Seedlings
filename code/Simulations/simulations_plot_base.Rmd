...
```{r}
name <- "1_2020-03-27_1000_empirical_welch_empiricalcoef_empiricalgrowth_empiricalindex"
...
He found 128 ABCO and 71 PIPO in those plots. On a per area basis, that's:
```{r}
128/900
```

0.1422 abco/ square meter

```{r}
71/900
```

0.0789 pipo per square meter 
