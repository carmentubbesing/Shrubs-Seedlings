...
# Load summary
```{r}
load(file = "../../results/data/summary_emerge_prop_base_Oct30.Rdata")
```

```{r}
load(file = "../../results/data/summary_emerge_density_base_Oct30.Rdata")
```
...
ggplot(summary_emerge_prop)+
  ...
  ylim(c(-0.05,1))
filename <- paste("../../results/figures/Simulations/base_prop_line_Oct29.png", sep = "")
...
filename <- paste("../../results/figures/Simulations/base_density_line_Oct29.png", sep = "")
ggsave(file = filename, width = 5, height =4, dpi = 400)
```
...
# Find mean prop emerged at end of sim for each species (for Table 1)
```{r}
summary_emerge_prop %>% 
  group_by(Species) %>% 
