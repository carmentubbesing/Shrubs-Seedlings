...
# Load summary
```{r}
load(file = "../../results/data/summary_emerge_prop_base.Rdata")
```

```{r}
load(file = "../../results/data/summary_emerge_density_base.Rdata")
```
...
ggplot(summary_emerge_prop)+
  ...
  ylim(c(0,1))
filename <- paste("../../results/figures/Simulations/base_prop_line.png", sep = "")
