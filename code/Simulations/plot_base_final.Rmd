...
# Load summary
```{r}
load(file = "../../results/data/summary_emerge_prop_base_Oct28.Rdata")
```

```{r}
load(file = "../../results/data/summary_emerge_density_base_Oct28.Rdata")
```
...
ggplot(summary_emerge_prop)+
  ...
  ylim(c(0,1))
filename <- paste("../../results/figures/Simulations/base_prop_line_Oct28.png", sep = "")
...
filename <- paste("../../results/figures/Simulations/base_density_line_Oct28.png", sep = "")
ggsave(file = filename, width = 5, height =4, dpi = 400)
```
