...
shrub_method <- "CECO" #emprical, welch, CECO, ARPA, CHSE, LIDE, OTHER
n_seedlings <- 200
```
...
```{r, warning=FALSE}
time <- Sys.time()
dfsimallreps <- iterate(iterations, fire, years_max, climate_method, conifer_species_method, shrub_method, n_seedlings)
