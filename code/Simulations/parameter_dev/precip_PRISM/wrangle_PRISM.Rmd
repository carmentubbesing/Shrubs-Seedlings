...
df <- read_csv("../../../../data/PRISM/PRISM_ppt_stable_4km_197001_201901_39.2267_-120.6117.csv", skip = 10, col_types = cols(Date = col_date(format = "%Y-%m"), `ppt (mm)` = col_double()))
head(df)
```
...
ggplot(df, aes(x = water_year, y= ppt_mm))+
  geom_point()+
  scale_x_discrete(breaks = c("1975-1976", "1985-1986", "1995-1996", "2005-2006", "2015-2016"))+
  theme_minimal()
```
...
# Save df
```{r}
save(df, file = "~/Shrubs-Seedlings/data/PRISM/clean_1970-present.Rdata")
```
