...
coef_all_norm %>% 
  ...
  scale_y_discrete(labels = c("Elevation", "Shrub competition", "Height/shrub interaction", "Heat load", "Slope", "Juvenile tree height", "Years since fire", "Potential incident radiation"))+
