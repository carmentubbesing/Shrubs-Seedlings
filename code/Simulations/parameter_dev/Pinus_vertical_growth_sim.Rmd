...
shrubarea_range_conservative <- cbind(min_shrub, max_shrub, median_shrub)
...
So no need to include an interaction
...
```{r}
LM_pine_nonnorm_sim <- lme(f, data = LMdf_nonnorm, random = ~ 1| Fire/Sdlg, method = "ML")
```
