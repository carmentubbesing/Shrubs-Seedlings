...
coef_all_norm %>% 
  ...
  scale_y_discrete(labels = c("Shrub species: deerbrush", "Basal diameter", "Shrub species: other", "Shrub species: whitethorn", "Year 2016", "Shrub species: bearclover", "Height/shrub interaction","Year 2017", "Shrub species: tanoak", "Heat load", "Shrub competition","Years since fire",  "Juvenile tree height"))+
