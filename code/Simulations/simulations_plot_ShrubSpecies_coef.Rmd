...
```{r}
date <- "2020-03-20"
namearpa <- paste("~/Simulations", date, "_1000AMRC_historic_empirical_welch_ARPAcoef.Rdata", sep = "")
namececo <- paste("~/Simulations", date, "_1000AMRC_historic_empirical_welch_CECOcoef.Rdata", sep = "")
...
plot_emerge_prop <- 
  ...
  #ggtitle(paste("Results for", max(dfsimallreps$rep), "simulations", sep = " "))+
  theme(legend.position = c(0.7, 0.3))+
  scale_fill_manual(values = c("#A9A9A9", "#d95f02", "#1b9e77", "#7570b3"),
    labels = c("White fir under all shrub species", 
