...
```{r}
date <- "2020-03-23"
namearpa <- paste("~/Simulations", date, "_1000AMRC_ARPAcoef_empiricalgrowth.Rdata", sep = "")
namececo <- paste("~/Simulations", date, "_1000AMRC_CECOcoef_empiricalgrowth.Rdata", sep = "")
