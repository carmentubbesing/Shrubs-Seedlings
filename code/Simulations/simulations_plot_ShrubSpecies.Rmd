...
namearpa <- paste("~/Simulations", date, "_1000AMRC_ARPA_empiricalcoef_empiricalgrowth.Rdata", sep = "")

namececo <- paste("~/Simulations", date, "_1000AMRC_CECO_empiricalcoef_empiricalgrowth.Rdata", sep = "")

namecein <- paste("~/Simulations", date, "_100AMRC_CEIN_empiricalcoef_empiricalgrowth.Rdata", sep = "")
```
...
plot_emerge_prop
filename <- paste("../../results/figures/Simulations/shrub_species_overall", Sys.Date(), ".png", sep = "")
