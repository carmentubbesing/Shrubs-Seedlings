...
namececo <- paste("~/Simulations", date, "_1000AMRC_CECO_empiricalcoef_empiricalgrowth.Rdata", sep = "")

namecein <- paste("~/Simulations", date, "_100AMRC_historic_empirical_CEIN_empiricalcoef_empiricalgrowth.Rdata", sep = "")
```
