...
Q50plot <- ggplot()+
  ...
  geom_errorbarh(data = Q50 %>% filter((simspp == "CEIN" & Species == "PIPO")), aes(col = simspp, y = simspp, xmin = lower, xmax = mean_cein_pipo), size = 1, height = 0)+
...
# Save
```{r}
filename <- paste("../../results/figures/Simulations/shrub_species_index_withQ50_facet", Sys.Date(), ".jpeg", sep = "")
