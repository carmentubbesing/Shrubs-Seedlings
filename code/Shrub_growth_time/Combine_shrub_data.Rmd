...
latimer <- latimer %>% 
  ...
  dplyr::select(Fire, years_since_fire, Year_meas, Year.of.Fire, Shrub_species, shrub_ht) %>% 
...
# Save combined data
```{r}
save(df, file = "~/Shrubs-Seedlings/compiled_data/shrub_growth/all_combined.Rdata")
```
