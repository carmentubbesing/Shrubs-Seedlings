...
```{r}
AIC(lmALL.ME)
AIC(lm(cover_sum ~ years_since_fire * Shrub_species +ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire * Shrub_species + Shrub_species*ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire + Shrub_species + ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire * Shrub_species * ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire  + Shrub_species*ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire * Shrub_species + Shrub_species *sqrt(ht_wt_mean_cm), data = me_totals))
AIC(lm(cover_sum ~ years_since_fire *sqrt(ht_wt_mean_cm), data = me_totals))
AIC(lm(cover_sum ~ years_since_fire *ht_wt_mean_cm, data = me_totals))
AIC(lm(cover_sum ~ years_since_fire + sqrt(ht_wt_mean_cm), data = me_totals))
AIC(lm(cover_sum ~ years_since_fire + ht_wt_mean_cm, data = me_totals))
```
