...
chse_plot <- ggplot()+
  ...
  theme_minimal()+
  ggtitle("Chrysolepis sempervirens")+
  xlab("Years since fire")+
  ylab("Shrub height (cm)")+
  theme(
    plot.title = element_text(face = "italic")
...
final_plot <- ggarrange(ceco_plot, arpa_plot, chse_plot, cein_plot, OTHER_plot, nrow = 2, ncol = 3)
final_plot
ggsave("~/Shrubs-Seedlings/results/figures/Shrub_growth_time/gam_fig_final.png", final_plot, width = 10)
```
