...
ggplot()+
  ...
  theme_bw()+
  geom_vline(aes(xintercept = exp(-2.268595)), col = "dark orange")+
  geom_text(aes(x= exp(-2.268595), label="\nminimum fire footprint shrub competition", y = ymax*.6), colour="dark orange", angle=90, size = 3) +
  
  geom_vline(aes(xintercept = exp(-1.68245)), col = "dark red")+
  geom_text(aes(x= exp(-1.68245), label="\nmaximum fire footprint shrub competition", y = ymax*.6), colour="dark red", angle=90, size = 3) +
  
  geom_vline(aes(xintercept = exp(-1.97947)), col = "red")+
  geom_text(aes(x= exp(-1.97947), label="\nmedian fire footprint shrub competition", y = ymax*.6), colour="red", angle=90, size = 3) +
...
ggplot()+
  ...
  geom_vline(aes(xintercept = exp(-1.307347)), col = "dark orange")+
  geom_text(aes(x= exp(-1.307347), label="\nminimum fire footprint shrub competition", y = ymax*.6), colour="dark orange", angle=90, size = 3) +
  
  geom_vline(aes(xintercept = exp(-2.325)), col = "dark red")+
  geom_text(aes(x= exp(-2.325), label="\nmaximum fire footprint shrub competition", y = ymax*.6), colour="dark red", angle=90, size = 3) +
  
  geom_vline(aes(xintercept = exp( -1.8263763)), col = "red")+
  geom_text(aes(x= exp( -1.8263763), label="\nmedian fire footprint shrub competition", y = ymax*.6), colour="red", angle=90, size = 3) 
