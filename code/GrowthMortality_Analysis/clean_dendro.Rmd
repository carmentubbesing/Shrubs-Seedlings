...
## Take out trees with only a few years
```{r}
...
rwl_live_pipo_gr4 <- rwl_live_pipo[,names(rwl_live_pipo) %in% names(sums)]
ncol(rwl_live_pipo_gr4)
```


##  Save filtered set
```{r}
write.rwl(rwl_live_pipo_gr4, fname = "../../data/GrowthMortality/live_pipo_gr4.rwl")
```
