...
### Make a function to add to a vector of trees whose age assignment I feel confident about
```{r}
sure <- c()
...
ringplot(161)
look(161)
add2017(161) # Growing, so likely died earlier in the 2017 season 
...
```{r}
dfafull %>% 
  select(tree, PERC_NEEDLES, NEEDLE_COLOR, BARK, BUDS)  %>% 
