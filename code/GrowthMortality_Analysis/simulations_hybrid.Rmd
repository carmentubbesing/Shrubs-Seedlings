...
ggplot()+
  ...
  geom_text(aes(x= exp(-1.41822), label="\nminimum fire footprint shrub competition", y = ymax*.6), colour="red", angle=90, size = 3) +
  geom_vline(aes(xintercept = exp(-2.5906)), col = "red")+
  geom_text(aes(x= exp(-2.5906), label="\nmaximum fire footprint shrub competition", y = ymax*.6), colour="red", angle=90, size = 3) +
