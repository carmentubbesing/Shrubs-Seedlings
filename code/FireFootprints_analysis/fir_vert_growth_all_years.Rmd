...
ggsave(file = "../../results/figures/FireFootprints/FirVertRel.png", width = 3.5, height = 3, dpi = 400)
```
...
ggsave(file = "../../results/figures/FireFootprints/FirVertRel.pdf", width = 3.5, height = 3, dpi = 400)
```
