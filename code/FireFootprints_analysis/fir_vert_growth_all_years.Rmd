...
A VIF cutoff value of 5 is often used, and heatload has a GVIF off 11.8, so I took it out and ran the model again. 

```{r}
LM <-  lme(VertGrowth_Rel ~ 
            Years + Aspect.rad.fold.NESW + incidrad + BasDia2016.cm + sqrt_shrubarea3 + Year,
           data = LMdf, random = ~ 1| Fire/Sdlg, method = "ML")
vif(LM)
summary(LM)
```
