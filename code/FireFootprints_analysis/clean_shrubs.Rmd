...
```{r}
sdlt <- sdlt %>% 
  rename(Ht2015.meas2016 = Ht2015)
```


## Reduce to variables of interest
```{r}
df <- sdlt[,c("Seedling.","Fire","FirePatch", "Elevation", "Species", "Slope.Deg","Aspect.deg","Ht.cm","BasDia.cm","LastYearGrth.cm","Light_File","DIFN", "ImmedAboveSpp", "ImmedAboveHt.cm", "Ht2015.meas2016")]
df <- tbl_df(df)
