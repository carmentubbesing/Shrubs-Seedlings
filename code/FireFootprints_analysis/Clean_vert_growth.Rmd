...
## Calculate 2015 height from 2017 data as the height BEFORE 2015 growth
```{r}
df <- df %>% 
  mutate_at(c("Growth_15", "Growth_16","Growth_17"), as.numeric) %>% 
  mutate(Ht2015.cm_spring_from2017 = Ht2017.cm-Growth_16-Growth_17-Growth_15)
```
...
df %>% 
  ...
  select(Sdlg, LastYearGrth.cm, Ht16_meas2016.cm, Ht2017.cm, Ht2015.meas2016, Growth_17, Growth_16, Growth_15)
```
...
find_apical_growth <- df %>% 
  ...
  select(Sdlg, Ht16_meas2016.cm, LastYearGrth.cm, Ht2015.meas2016, apical_growth_2016) %>% 
  distinct()
find_apical_growth
...
df %>% 
  filter(is.na(Ht2017.cm)) %>% 
  select(Sdlg, Ht16_meas2016.cm, LastYearGrth.cm, Ht2015.meas2016, Ht2015.calc2016) 
```
...
df %>% 
  filter(is.na(Ht2015.cm_spring)) %>% 
  select(Sdlg, LastYearGrth.cm, Ht16_meas2016.cm, Ht2017.cm, Ht2015.meas2016, Growth_17, Growth_16, Growth_15, notes)
```
...
df %>% 
  ...
  select(Sdlg, LastYearGrth.cm, Ht16_meas2016.cm, Ht2017.cm, Ht2015.meas2016, Growth_17, Growth_16, Growth_15, notes, Ht2016.cm_spring, Ht2017.cm_spring, Ht2015.cm_spring)
```
...
names(df)
df <- df %>% 
  select (-ImmedAboveSpp, -ImmedAboveHt.cm, -IAG)
```
...
df %>% 
  filter(is.na(VertGrowth_cm)) %>% 
  select(Sdlg, VertGrowth_cm, LastYearGrth.cm, Ht16_meas2016.cm, Ht2017.cm, notes)
df <- df %>% 
...
df %>% 
  filter(Sdlg == "195") %>% 
  select(Sdlg, Year, LastYearGrth.cm, VertGrowth_cm, Ht16_meas2016.cm, Ht2017.cm, Ht2015.meas2016)
```
...
df %>% 
  filter(is.na(Ht_cm)) %>% 
  select(Sdlg, LastYearGrth.cm, Ht2016.cm_spring, Ht2017.cm, Ht2015.meas2016, Year, VertGrowth_cm, notes)
```
...
```{r}
df %>% select(Sdlg, Year, Ht_cm, VertGrowth_cm) %>% arrange(Sdlg)
df <- df %>% 
  rename(Ht_cm1 = Ht_cm) %>% 
  mutate(Ht_cm2 = Ht_cm1+VertGrowth_cm) %>% 
  mutate(VertGrowth_Rel = (Ht_cm2 - Ht_cm1)/Ht_cm1) %>% 
  mutate(VertGrowth_Rel = log(VertGrowth_Rel))
df %>% select(Sdlg, Year, Ht_cm1, Ht_cm2, VertGrowth_cm, VertGrowth_Rel) %>% arrange(Sdlg)
```
