...
```{r}
fit <- randomForest(formula = RGR ~ Fire  + shrubarea2 + shrubarea3 + Cov1 + Cov1.2 + Cov1.3 + Ht1 + Ht1.2 + Ht1.3 + ShrubSpp01 + ShrubSpp02 + ShrubSpp03 + IAG + shrubarea2_sqrt_norm+ Cov1.2_norm + Cov1.3_norm + IAG+ ShrG1+ shrubarea2_sqrt_norm:tree_Ht_log_norm+ Cov1.2_norm:tree_Ht_log_norm+ BasDia2016.cm+ vol_pre_cm2+ tree_Ht_log_norm, 
                    data = df,
                    importance = TRUE,
                    mtry = 13)
fit
