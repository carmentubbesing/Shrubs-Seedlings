...
```{r}
v1 <- c("shrubarea2_sqrt_norm", "Cov1.2_norm" , "Cov1.3_norm" , "IAG", "ShrG1", "shrubarea2_sqrt_norm:Ht_log_norm", "Cov1.2_norm:Ht_log_norm")
...
for(i in 1:length(combs)){
  ...
  f <- formula(paste("(RGR ~ Ht_log_norm +", vars,")"))
