...
```{r}
save(df18, file = "~/../Dropbox (Stephens Lab)/Shrub_experiment/Data/JOINED_DATA/df2018.Rdata")
write.csv(df18, file = "~/../Dropbox (Stephens Lab)/Shrub_experiment/Data/JOINED_DATA/compiled_cleaned_Aug2018.csv", row.names = F)
```
